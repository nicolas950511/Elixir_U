defmodule NodoServidor1 do
  @moduledoc """
  Módulo que representa el servidor 1 encargado de procesar los mensajes relacionados con
  las conversiones a mayúsculas. El servidor registra un servicio global y escucha
  los mensajes que recibe, procesándolos y enviando las respuestas correspondientes.

  ## Variables:
    - `@nombre_servicio_global`: Nombre global del servicio de mayúsculas.
  """

  @nombre_servicio_global :servicio_mayusculas
  ...
  ## Flujo:
    - Muestra un mensaje indicando que es el servidor de mayúsculas.
  ...
  un texto a mayúsculas, lo procesa y responde al productor.

  ## Flujo:
    - Si el mensaje es `:fin`, muestra un mensaje de desconexión y termina.
    - Si el mensaje es un texto, lo convierte a mayúsculas y envía la respuesta.
  """
  ...
  es una solicitud de conversión a mayúsculas, convierte el mensaje a mayúsculas. Si el mensaje
  ...
  ## Retorno:
    ...
    - El mensaje convertido a mayúsculas si la solicitud es `{:mayusculas, mensaje}`.
  ...
  @doc """
  Envía la respuesta procesada de vuelta al productor que envió el mensaje.

  ## Parámetros:
    - `respuesta`: La respuesta que debe ser enviada.
    - `productor`: El proceso productor al que se enviará la respuesta.
  """
